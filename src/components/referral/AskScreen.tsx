    ...
    <div className="flex flex-col gap-6">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        <div className="flex flex-col gap-1.5">
          <label htmlFor="contactName" className="text-sm font-medium text-foreground/80">
            Their name
          </label>
          <input
            id="contactName"
        ...
        <div className="flex flex-col gap-1.5">
          <span className="text-sm font-medium text-foreground/80">How should this go?</span>
      ...
      <button
        ...
        className="text-sm text-foreground/50 underline decoration-foreground/20 underline-offset-4 transition-colors hover:text-foreground/80"
      >
